...
{ ; V1toV2: Added bracket
    ...
    MsgBox("Active workbook name: <" Wbk.Name    ">`n"            . "Active workbok path: <"  Wbk.Path    ">`n"            . "Excel caption: <"        AppCap      ">")
return
...
GetActiveWorkbook()
{
    ...
    WinClass := WinGetClass("A")  ; Get the window class - "XLMAIN" is expected.
