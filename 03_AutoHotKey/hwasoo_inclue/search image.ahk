...
^d:: ; Define a hotkey (Ctrl + D) to search and click the image
{
    ...
    Try {
        ...
        ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight,  google_lens.png
    ...
    Try {
        ...
        ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight,  pasteimage.png
        MouseClick, left, %FoundX%, %FoundY%
        Sleep, 1000
...
Try {
    ...
    CoordMode, Pixel, Screen
    ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, *32 translate.png
