...
Tab.UseTab(1) ;Tab 1 Positioning
...
DDL_Type := goo.Add("DropDownList", "x160 y128 w120 Choose1", ["Type1", "Type2"])
ExitBtn := goo.Add("Button", "x176 y190 w67 h23", "&Exit")
Checkbox := goo.Add("CheckBox", "x50 y162 w250 h23 -Checked", "Save info to file")
SubmitBtn1 := goo.Add("Button", "x56 y190 w66 h23 Default", "&Submit")

Tab.UseTab(2) ;Tab 2 Positioning
goo.SetFont("s8")
goo.Add("Text", "x16 y8 w269 h23 +0x200", "Select a choice")
goo.Add("Text", "x24 y56 w112 h23 +0x200", "Choice")
DDL_Option := goo.Add("DropDownList", "x152 y56 w120 Choose1", ["Any", "Choice1", "Choice2", "Choice3", "Choice4"])
goo.Add("Text", "x24 y112 w112 h23 +0x200", "Area")
DDL_Area := goo.Add("DropDownList", "x152 y112 w120 Choose1", ["Any", "Area 6", "Area 5", "Area 4", "Area 3", "Area 2", "Area 1"])
SubmitBtn2 := goo.Add("Button", "x109 y171 w80 h23", "S&ubmit")

Tab.UseTab(3) ;Tab 3 Positioning
goo.SetFont("s9")
...
Choices := goo.Add("DropDownList", "x152 y105 w120 Choose1", ["Select One", "Choice1", "Choice2", "Choice3"])
SubmitBtn3 := goo.Add("Button", "x109 y180 w80 h23", "Submi&t")
...
Tab.UseTab(4) ;Tab 4 Positioning
goo.SetFont("s10")
...
ButtonSubmit4 := goo.Add("Button", "x176 y190 w80 h23 +Center", "&Submit")


/* Tab 1 Function Callers */
SubmitBtn1.OnEvent("Click", Tab1_Submit_Handler)
ExitBtn.OnEvent('Click', (*) => goo.Destroy())
CheckBox.OnEvent("Click", CB_Event_Handler)
DDL_Type.OnEvent("Change", DDL_Type_Handler)
DDL_Area.OnEvent("Change", DDL_Area_Handler)
/* Tab 2 Function Callers */
DDL_Option.OnEvent("Change", DDL_Type_Handler)
DDL_Area.OnEvent("Change", DDL_Area_Handler)
SubmitBtn2.OnEvent("Click", Tab2_Submit_Handler)


/* Tab 3 Function Callers */
SubmitBtn3.OnEvent("Click", Tab3_Submit_Handler)
Choices.OnEvent("Change", Choices_Handler)

/* Tab 4 Function Callers */
ButtonSubmit4.OnEvent("Click", Tab4_Submit_Handler)
